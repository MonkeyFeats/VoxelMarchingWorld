...
void threedee(int id)
{
	...
	if(p !is null)
	{
		...
		{			
			...
			f32 eye_height = b.get_f32("pos_y")/8;
			Vec2f pos = Vec2f(b.get_f32("pos_x"),b.get_f32("pos_z"))/8;

			//u8 RayDist = b.get_u8("CursorDist");

			Vec2f dirxy =  Vec2f( (3-(Maths::Abs(b.get_f32("dir_y")/90)*3))*8 , 0);
    		Vec2f aimPosxy = dirxy.RotateBy(b.get_f32("dir_x"));

    		b.set_Vec2f("aim_pos", (pos*8)+Vec2f(aimPosxy.y, aimPosxy.x));
			b.set_f32("aim_posZ", b.get_f32("dir_y")-10); 
			...
			// third person-ish
			//Matrix::SetTranslation(cam, 0, 0, 6);						
			...
			{
				voxmap.RenderWorld(pos, model, eye_height);
				//voxmap.RenderCursor(pos, cam, NewCameraAngleX, NewCameraAngleY, proj, eye_height);
			}
